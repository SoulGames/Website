...
<head>
	...
	<!-- SEO -->
	<meta name="title" content="SoulGames.DE | Wartungen">
	...
	<script>
		var countDownDate = new Date("Apr 26, 2020 10:00:00").getTime();
		...
		var x = setInterval(function() {
			...
			if (distance < 0) {
				clearInterval(x);
				document.getElementById("counter").innerHTML = "Bitte warten!";
			}
		}, 1000);
	</script>
</head>
<body>
	...
	<section id="gamemodes">
		<h1 id="message">Wartungsarbeiten</h1>
		<h2 id="message">Aktuell sind wir in Wartungen!</h2>
		<hr><br>
